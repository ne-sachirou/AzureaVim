Azurea.loadjs({
    ...
    "src/plugins/shindan": ["src/AzureaVim", "src/plugins/unshorten"],
    "src/plugins/translate": ["src/AzureaVim"],
    "src/plugins/unshorten": ["src/AzureaVim"],
    "src/plugins/view": ["src/AzureaVim"]
});